...
public class MainActivity extends Activity {
    ...
    private int[] symbol = {
            R.drawable.bit, R.drawable.ethe
    };
    ...
    private int[] flags = {
            ...
            R.drawable.liberia, R.drawable.malaysia, R.drawable.japan
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            ...
            CharSequence savedCrpto = savedInstanceState.getCharSequence(CRYPTO_TEXT_VALUE);
            cryptoEntered.setText(savedCrpto);
        }
    ...
    private void fiatArrayList() {
        ...
        list.add(new ItemObject("Japan Yen", R.drawable.japan));
    ...
    private void cryptoArrayList() {
        ...
        ArrayList<ItemObject> list = new ArrayList<>();
        list.add(new ItemObject("Bitcoin", R.drawable.bit));
        list.add(new ItemObject("Ethereum", R.drawable.ethe));
        CyrptoAdapter cryptoAdapter = new CyrptoAdapter(this,
                R.layout.spinner_layout, R.id.txt, list);
